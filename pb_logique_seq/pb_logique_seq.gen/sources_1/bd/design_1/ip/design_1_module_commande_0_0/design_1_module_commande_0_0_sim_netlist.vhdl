...
--               d:/Gabriel/Documents/Universite/S4/APP2/pb_logique_seq/pb_logique_seq.gen/sources_1/bd/design_1/ip/design_1_module_commande_0_0/design_1_module_commande_0_0_sim_netlist.vhdl
...
entity design_1_module_commande_0_0_conditionne_btn_v7 is
  port (
    ...
    clk : in STD_LOGIC;
    \FSM_sequential_Sreg_reg[1]\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
inst_cond_btn: entity work.design_1_module_commande_0_0_conditionne_btn_v7
     port map (
      ...
      \FSM_sequential_Sreg_reg[1]\(1) => Sreg(1),
      \FSM_sequential_Sreg_reg[1]\(0) => \^q\(0),
      Q(3 downto 0) => o_btn_cd(3 downto 0),
      clk => clk,
...
begin
  o_selection_par(1) <= \<const0>\;
  o_selection_par(0) <= \<const0>\;
